...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (golden-ratio helm helm-c-yasnippet elpy org-beautify-theme org-beautify noctilux-theme dracula-theme smartparens paredit-everywhere clj-refactor flycheck-clojure paredit 4clojure cider systemd swiper pyvenv ac-cider ein sml-mode mu4e-maildirs-extension csv-mode zzz-to-char zop-to-char helm-themes helm-descbinds undo-tree jedi auto-yasnippet multi-term yaml-mode xkcd web-mode use-package spaceline sos smex rcirc-notify rainbow-mode rainbow-identifiers pkg-info page-break-lines org-bullets multiple-cursors mingus markdown-mode magit lua-mode jinja2-mode ido-vertical-mode ido-hacks ibuffer-vc helm-swoop guide-key git-timemachine git-gutter-fringe gist flx f expand-region edit-server dockerfile-mode darktooth-theme counsel charmap bug-hunter bbcode-mode avy auto-complete ag)))
